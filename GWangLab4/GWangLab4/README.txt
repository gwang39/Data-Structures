...
Warning: please make sure there is only one '.' (dot) existed in the file (which is in extention) because program file writer searches for this dot to modify the output file name 
