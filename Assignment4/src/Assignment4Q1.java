 ...
 * This program displays monthly calendar based on month and year input by user
 * 
...
{	
	...
	{	
		...
		int m = input.nextInt();	// get month
		
		System.out.println();	

		printMonthCalendar (m, y);	// display monthly calendar based on year and month
	...
	public static int getNumDaysInMonth( int m, int y)
	{
		...
		switch(m)	//determines the number of days based on months
		{
         ...
         case 11:
             ...
             break;
         case 2:
             if (isLeapYear(y))	// check if it"s a February in a leap year
                 days = 29;
             else
                 days = 28;
             break;
